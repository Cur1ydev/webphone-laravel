                        ...
                        <div class="col-xxl-8 col-lg-10 m-auto">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{route('admin.editProductPost',['id'=>$getProduct->id])}}" method="post" class="theme-form theme-form-2 mega-form">
                                        <div class="mb-4 row align-items-center">
                                            <label class="form-label-title col-sm-3 mb-0">Tên sản phẩm</label>
                                            <div class="col-sm-9">
                                                <input name="name_product" class="form-control" type="text"
                                                       placeholder="Tên sản phẩm" value="{{$getProduct->name_product}}">
                                            </div>
                                            @error('name_product')
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="memory_storage" class="form-control" type="text"
                                                       placeholder="Bộ nhớ trong" value="{{$getProduct->memory_storage}}">
                                            </div>
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="code_color" class="form-control" type="text"
                                                       placeholder="Mã Màu" value="{{$getProduct->code_color}}">
                                            </div>
                                            @error('code_color')
                                            <h5  style="color: red" align="center">{{$message}}</h5>
                                            @enderror
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="slug" class="form-control" type="text"
                                                       placeholder="Slug" value="{{$getProduct->slug}}">
                                            </div>
                                            @error('slug')
                                            <h5  style="color: red" align="center">{{$message}}</h5>
                                            @enderror
                                            ...
                                            <div class="col-sm-9">
                                                <select name="parent_id" class="js-example-basic-single w-100">
                                                    ...
                                                    @foreach($allCategory as $key => $value)
                                                        <option value="{{$value->id}}" {{$getProduct->parent_id==$value->id?'selected':''}}>{{$value->cate_product}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            @error('parent_id')
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="image" class="form-control" type="text"
                                                       placeholder="Đường dẫn ảnh" value="{{$getProduct->image}}">
                                            </div>
                                            @error('image')
                                            <h5  style="color: red" align="center">{{$message}}</h5>
                                            @enderror
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="quantity" class="form-control" type="text"
                                                       placeholder="Tổng số lượng" value="{{$getProduct->quantity}}">
                                            </div>
                                            @error('quantity')
                                            <h5  style="color: red" align="center">{{$message}}</h5>
                                            @enderror
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="price" class="form-control" type="text"
                                                       placeholder="Giá" value="{{$getProduct->price}}">
                                            </div>
                                            @error('price')
                                            <h5  style="color: red" align="center">{{$message}}</h5>
                                            @enderror
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="color" class="form-control" type="text"
                                                       placeholder="Màu sắc" value="{{$getProduct->color}}">
                                            </div>
                                            @error('color')
                                            <h5  style="color: red" align="center">{{$message}}</h5>
                                            @enderror
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea  name="description" id="" cols="60" rows="10"
                                                           placeholder="Mô tả" >{{$getProduct->description}}</textarea>
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="feature_product" class="js-example-basic-single w-100">
                                                    ...
                                                    <option value="1" {{$getProduct->feature_product==1?'selected':''}}>Có</option>
                                                    <option value="0" {{$getProduct->feature_product==0?'selected':''}}>Không</option>
                                                </select>
                                            </div>
