...
<div class="page-wrapper">
    ...
    <div class="top-info-bar style1">
        <div class="topBar-slider-style1 alert fade show" role="alert">
            ...
            <div class="item text-center d-flex d-flex-justify-center lh-base">
                FREE shipping on orders over $150 <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"><i class="an an-times-l"></i></button>
            </div>
        </div>
    </div>
    <!--End Topbar-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6 col-sm-6 col-md-6 col-lg-2 align-self-center justify-content-start d-flex">
                        ...
                        <!--End Mobile Toggle-->
                        <!--Logo-->
                        <div class="logo d-flex-center"><a href="{{route('client.home')}}"><img class="logo-img mh-100" src="{{asset('assets/images/logo-demo17-1.png')}}" alt="Optimal Multipurpose eCommerce Bootstrap 5 Html Template" title="Optimal Multipurpose eCommerce Bootstrap 5 Html Template" width="120" /><span class="logo-txt d-none">Optimal</span></a></div>
                        <!--End Logo-->
                    </div>
                    <!--End Logo / Menu Toggle-->
                    <!--Search Inline-->
                    <div class="col-1 col-sm-1 col-md-1 col-lg-8 d-none d-lg-block">
                        <form class="form minisearch search-inline w-100 px-5" id="header-search1" action="{{route('client.search')}}" method="get">
                            ...
                            <div class="control">
                                <div class="searchField d-flex">
                                    ...
                                    <div class="input-box d-flex w-100">
                                            <input type="text" name="search" placeholder="Tìm kiếm sản phẩm" value="{{old('search')}}"
                    ...
                    <div class="col-6 col-sm-6 col-md-6 col-lg-2 align-self-center icons-col text-right d-flex justify-content-end">
                        ...
                        <!--End Wishlist-->
                        <!--Setting Dropdown-->
                        <div class="user-link iconset flex-lg-column"><i class="icon an an-user-expand"></i><span class="text d-none d-lg-flex">ACCOUNT</span></div>
                        ...
                        <div class="header-cart iconset flex-lg-column">
                            <a href="#" class="site-header__cart btn-minicart d-flex-justify-center flex-lg-column" data-bs-toggle="modal" data-bs-target="#minicart-drawer">
                                <i class="icon an an-sq-bag"></i><span class="text d-none d-lg-flex">CART</span><span class="site-cart-count counter d-flex-center justify-content-center position-absolute rounded-circle">0</span>
                            </a>
                        </div>
                        <!--End Minicart Drawer-->
                        <!--Setting Dropdown-->
                    ...
                    <div class="col-1 col-sm-1 col-md-1 col-lg-12 align-self-center d-menu-col">
                        <nav class="grid__item" id="AccessibleNav">
                            <ul id="siteNav" class="site-nav center hidearrow">
                                <li class="lvl1 parent megamenu"><a href="{{route('client.home')}}">Home <i class="an an-angle-down-l"></i></a>
                                </li>
                                @foreach($allCateProduct as $item => $value)
                                <li class="lvl1 parent megamenu"><a href="{{route('client.category',['category'=>$value->slug])}}">{{$value->cate_product}} <i class="an an-angle-down-l"></i></a>
                                </li>
                                @endforeach
